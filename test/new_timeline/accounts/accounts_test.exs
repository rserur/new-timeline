defmodule NewTimeline.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{is_active: true, name: "some name", username: "some username"}
    @update_attrs %{is_active: false, name: "some updated name", username: "some updated username"}
